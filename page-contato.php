...
<?php include( TEMPLATEPATH . "/inc/introducao.php"); ?>
		...
		<section class="contato container animar-interno">
			...
			<div class="contato_dados grid-8">
				<h3>Dados</h3>
				<span><?php the_field('fone'); ?></span>
				<span><?php the_field('mail'); ?></span>
				<span><?php the_field('addres'); ?></span>
				<span><?php the_field('addres2'); ?></span>
				<h3>Redes Sociais</h3>
		...
		<section class="container contato_mapa">
			<a href="<?php the_field('link_mapa'); ?>" target="_blank" class="grid-16"><img src="<?php the_field('imagem_mapa'); ?>" alt="<?php the_field('endereco_bikcraft'); ?>"></a>
		</section>
